...
DELETE FROM vault.secrets WHERE name = 'firebase';
...
drop server if exists firebase_server cascade;
create server firebase_server
  foreign data wrapper firebase_wrapper
  options (
    sa_key_id '890b74b1-63d2-4d47-8783-49b6268cb801', -- The Key ID from above.
    project_id 'compsci-computations'
);
