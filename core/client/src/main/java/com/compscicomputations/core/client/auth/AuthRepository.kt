package com.compscicomputations.core.client.auth

import android.util.Log
import com.compscicomputations.core.client.auth.models.AuthUser
...
interface AuthRepository {
    ...
    companion object {
        ...
        val isUserSignedIn: Boolean = TODO()
...
//            }
         ...
         */
        fun getAuthUser(withUsertype: Boolean = true): AuthUser =
            TODO()
