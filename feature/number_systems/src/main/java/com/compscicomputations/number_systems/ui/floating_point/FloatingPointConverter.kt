...
import com.compscicomputations.number_systems.utils.Binary16_Ieee754
...
object FloatingPointConverter {
    ...
    fun FloatingPointUiState.fromDecimal(decimal: String): FloatingPointUiState {
        ...
        try {
            ...
            val binary16 = Integer.toBinaryString(Binary16_Ieee754.floatToBinary16ShortBits(float).toInt())
    ...
    fun FloatingPointUiState.fromBinary16(binary16Str: String): FloatingPointUiState {
        try {
            ...
            val float = Binary16_Ieee754.binary16ShortBitsToFloat(intBits.toShort())
    ...
    fun FloatingPointUiState.fromBinary64(binary64Str: String): FloatingPointUiState {
        try {
            ...
            val binary16 = Integer.toBinaryString(Binary16_Ieee754.floatToBinary16ShortBits(double.toFloat()).toInt())
