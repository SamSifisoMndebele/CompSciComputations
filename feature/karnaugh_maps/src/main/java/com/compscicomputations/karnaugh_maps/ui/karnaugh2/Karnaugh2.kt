...
import com.compscicomputations.karnaugh_maps.databinding.Karnaugh2Binding
...
//    }
    Column(modifier = modifier) {
                    ...
                    DropdownMenuItem(
                        ...
                        onClick = {
                            coroutineScope.launch {
                                TwoVarsDataStore.setConvertFrom(context, it, when(it) {
        ...
        if (uiState.convertFrom.isExpression) {
            ...
            LaunchedEffect(textFieldState.value) {
                ...
                coroutineScope.launch(Dispatchers.IO) {
                    TwoVarsDataStore.setValue(context, textFieldState.value.text)
                }
            }
            DisableSoftKeyboard {
                OutlinedTextField(
        ...
        AndroidViewBinding(Karnaugh2Binding::inflate, Modifier.fillMaxWidth()) {
                ...
                kMap.setOnTouchListener { map, motionEvent ->
                    if (motionEvent.action == 0) true
                        ...
                        if (findClosestMinTerm > -1) {
                            ...
                            coroutineScope.launch(Dispatchers.IO) {
                                TwoVarsDataStore.setValue(context, kMap.minterms.joinToString(";"))
                            }
                        }
                        false
                    }
