...
import com.compscicomputations.polish_expressions.ui.TokenName.*
...
internal fun List<Token>.asString(filterAsterisk: Boolean = false): String =
    filterNot { filterAsterisk && it.lexeme.contains('*') }.joinToString(" ") { it.lexeme }
