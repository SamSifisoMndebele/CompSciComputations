...
//    message: String = "A user associated with the uid doesn't exist, or it was deleted."
//): NoSuchElementException(message)
//
//private class IllegalUserState: IllegalArgumentException("There is more than one user associated to the uid.")
